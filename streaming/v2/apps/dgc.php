...
if (!empty($_GET['collection'])) {
    $collection = $_GET['collection']; $title_ref = "0000"; 
} else {
...
<!-- Stream Key -->
<div class="subsection">Stream Key : <?php 
if ($Stream != "") {
...
<!-- Show Runner -->
<div id="ShowRunner">
<div class="subsection">Déroulé de la Production</div><input class="hidden" id="run-state" value="">
...
<div id="TitleCollections">
    ...
    <div class="dropdown full">
        ...
        foreach ($Collections as $CollectionRef) {            
            ...
            if ($CollectionRef != "ENPJJ") {
                echo "\t\t\t".'<span style="cursor:pointer !important;" onclick="Delete(\''.$CollectionRef.'\')" class="delete">&#10006;</span></li>'."\r\n"; 
            }
...
<?php
    ...
    if ($title_ref == '0000' || $title_ref == '') {
        ...
        if (isset($StyleInfo[$stream_css])) {
            $stream_style = $StyleInfo[$stream_css]; 
        } else {
            $stream_css == $default_css;
            $stream_style = $default_style; 
        }
...
<div id="StreamInfo">
    ...
    <div class="dropdown full">
        ...
        foreach ($StyleInfo as $StyleRef => $StyleName) {
            if ($StyleName != "ENPJJ" && $StyleRef != "perso") {
    ...
    <div class="dropdown full"><div onclick="DropDown(this)" class="dropdown-menu">Rappel de titre :</div>
        ...
        foreach ($StreamInfo as $FileRef => $Info) {
            ...
            if (strlen($beartitle)>30) {
                ...
                $shorten_title = strip_tags($title); 
            }
