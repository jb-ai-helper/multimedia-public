...
function ToggleSelector(){
    ...
    if(EditorStatus){
		...
		var AddedStyleSheet = PreviewCode.head.getElementById('AddedStyleSheet');
		
		if(AddedStyleSheet){
			var AddedStyleURL = AddedStyleSheet.getAttribute('href');
			var AddedStyle = fetch(AddedStyleURL).then(respose => response.text());
